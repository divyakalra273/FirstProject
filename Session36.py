...
def answer3():
    ...
    plt.pie(salesYear2011DataCountryWise.values,salesYear2011DataCountryWise.labels)
    plt.show()
...
def answer4():
    ...
    print("~~~~~~~~~~")
    print("Group the Data Invoice Wise for Year 2011: ")
    salesYear2011DataInvoiceWise = salesYear2011Data.groupby('InvoiceNo').sum()['Amount']
    plt.scatter(salesYear2011DataInvoiceWise.values,salesYear2011DataInvoiceWise.index)
    plt.grid(True)
    plt.show()
