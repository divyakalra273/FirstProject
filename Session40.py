...
dataSet.outlook[dataSet.outlook == 'overcast'] = 2
...
def computeEntropyDataSet():
    ...
    return -((len(dataSet[dataSet['play'] == 'yes']) / len(dataSet['play'])) * np.log2(
        (len(dataSet[dataSet['play'] == 'yes']) / len(dataSet['play'])))) - (
                       (len(dataSet[dataSet['play'] == 'no']) / len(dataSet['play'])) * np.log2(
                   (len(dataSet[dataSet['play'] == 'no']) / len(dataSet['play']))))
